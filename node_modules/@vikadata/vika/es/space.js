...
var datasheet_1 = require("./datasheet/datasheet");
var SpaceManager = /** @class */ (function () {
    function SpaceManager(apitable, spaceId) {
        if (spaceId === void 0) { spaceId = ''; }
        this.apitable = apitable;
        this.spaceId = spaceId;
    }
    SpaceManager.prototype.datasheet = function (datasheetId) {
        if (!this.spaceId) {
        ...
        if (!datasheetId) {
            throw new Error('Please pass the datasheet id, which can be retrieved from the datasheet url, ' +
    ...
    Object.defineProperty(SpaceManager.prototype, "datasheets", {
        get: function () {
     ...
     */
    SpaceManager.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.apitable.request({
                        path: "/spaces",
                        method: 'get',
                    })];
            });
